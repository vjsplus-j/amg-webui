...
const mountProps = computed(() => getSampleMountProps('MiniNav'))
...
const codeBasic = demoSfc({
  ...
  script: [`const mountProps = getSampleMountProps('MiniNav')`],
  template: [`  <MiniNav v-bind="mountProps" />`]
})
