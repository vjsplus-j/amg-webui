...
import { VcrStorageDashboard } from '@amg-webui/components/base'
...
<template>
  <div class="vp-curated">
    <p class="vp-curated__lead">{{ t('example.doc.vcrStorageDashboard.when') }}</p>
    <DemoBlock
      ...
      default-open
    >
      <VcrStorageDashboard v-bind="mountProps" />
    </DemoBlock>
