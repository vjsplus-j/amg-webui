...
const re = {
  ...
  third:
    /Preview|Print|Excel|Pdf|AudioPlay|Ocr|Crypto|Clipboard|Browser|DragCanvas|DragMaterial|Canvas|PropPanel|TemplateDrag|FreeLayout|GridLayout|DragVerify|CanvasIo|DragWrapper|DragRuler|DragSort|Qrcode|Barcode|FilePreview|ImageCrop/,
