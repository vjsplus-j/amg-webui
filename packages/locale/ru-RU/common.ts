export default {
  ...
  'chrome.direction': 'Направление текста',
  'chrome.dirLtr': 'LTR',
  'chrome.dirRtl': 'RTL',
  ...
  'chrome.contextCopy': 'Копировать',
  'chrome.contextPaste': 'Вставить',
  'chrome.contextSelect': 'Выделить',
  'chrome.contextSelectAll': 'Выделить всё',
  'chrome.contextInspect': 'Проверить',
