...
import type { MiniNavProps, MiniNavEmits, NavItem } from './types'
import './style.scss'
...
<template>
  <nav :class="rootClass" :style="style" role="navigation">
    <button
      ...
      :key="i"
      type="button"
      :class="['vp-mini-nav__item', { 'vp-mini-nav__item--active': (item.value ?? item.label) === modelValue }]"
