...
import type { TreeNode, TreeLoadFn } from '@amg-webui/utils/data-display/tree-types'
...
export interface TreeProps extends BaseTreeProps {
  /** Opt-in virtual scroll for large flat lists. Prefer VirtualTree for always-on virtualization. */
  virtual?: boolean
}
...
export interface LazyTreeEmits extends TreeEmits {
  (e: 'load', ctx: import('@amg-webui/utils/data-display/tree-types').LazyLoadContext): void
}
