...
defineOptions({ inheritAttrs: false, name: "MonthPicker" });
...
function choose(month: number) {
  if (isDisabled.value || props.readonly || monthDisabled(month)) return;
...
function togglePanel() {
  if (!isDisabled.value && !props.readonly) toggle();
}
