...
<template>
  <div class="showcase-page">
    <h1>GB28181 Center</h1>
    <p class="showcase-page__lead">National standard video platform sample — SIP device catalog mock CRUD.</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the GB Devices route to explore list + dialog CRUD with loading,
