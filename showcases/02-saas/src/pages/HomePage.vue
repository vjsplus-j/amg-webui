...
<template>
  <div class="showcase-page">
    <h1>SaaS Console</h1>
    <p class="showcase-page__lead">Multi-tenant SaaS operator console with tenant subscription mock CRUD.</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the Tenants route to explore list + dialog CRUD with loading,
