...
<template>
  <div class="showcase-page">
    <h1>Admin Console</h1>
    <p class="showcase-page__lead">Classic enterprise admin shell — users, settings, and mock CRUD patterns.</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the Users route to explore list + dialog CRUD with loading,
