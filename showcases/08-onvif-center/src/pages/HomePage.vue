...
<template>
  <div class="showcase-page">
    <h1>ONVIF Center</h1>
    <p class="showcase-page__lead">ONVIF discovery and channel registry sample with mock CRUD.</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the ONVIF Devices route to explore list + dialog CRUD with loading,
