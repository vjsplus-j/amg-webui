...
<template>
  <div class="showcase-page">
    ...
    <p class="showcase-page__lead">VMS-style camera channel management sample (mock data only).</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the Cameras route to explore list + dialog CRUD with loading,
