...
<template>
  <div class="showcase-page">
    <h1>Content CMS</h1>
    <p class="showcase-page__lead">Editorial CMS sample for articles/pages with content entry mock CRUD.</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the Articles route to explore list + dialog CRUD with loading,
