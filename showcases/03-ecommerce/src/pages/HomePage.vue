...
<template>
  <div class="showcase-page">
    <h1>E-Commerce Ops</h1>
    <p class="showcase-page__lead">Catalog and order operations sample with product mock CRUD.</p>
    <Card title="Quick start">
      ...
      <Message severity="info" :closable="false">
        Open the Products route to explore list + dialog CRUD with loading,
